(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.candy2 = {}));
	...
	***************************************************************************** */
	...
	class Circle$2 {
	    ...
	    qtIndex(node) {
	        ...
	        for (let i = 0; i < nodes.length; i++) {
	            if (Circle$2.intersectRect(this.x, this.y, this.r, nodes[i][0], nodes[i][1], nodes[i][0] + w2, nodes[i][1] + h2)) {
	                indexes.push(i);
	            }
	        }
	        return indexes;
	...
	class Line$2 {
	    ...
	    qtIndex(node) {
	        ...
	        for (let i = 0; i < nodes.length; i++) {
	            if (Line$2.intersectRect(this.x1, this.y1, this.x2, this.y2, nodes[i][0], nodes[i][1], nodes[i][0] + w2, nodes[i][1] + h2)) {
	                indexes.push(i);
	            }
	        }
	        return indexes;
	...
	var quadtree_esm = /*#__PURE__*/Object.freeze({
		__proto__: null,
		Circle: Circle$2,
		Line: Line$2,
		Quadtree: Quadtree,
	...
	var require$$1$1 = /*@__PURE__*/getAugmentedNamespace(quadtree_esm);

	var common = {};

	Object.defineProperty(common, "__esModule", { value: true });
	common.unreachable = common.todo = common.assert = void 0;
	...
	var event_listener_registry = {};

	var hasRequiredEvent_listener_registry;

	function requireEvent_listener_registry () {
		if (hasRequiredEvent_listener_registry) return event_listener_registry;
		hasRequiredEvent_listener_registry = 1;
		Object.defineProperty(event_listener_registry, "__esModule", { value: true });
		event_listener_registry.EventListenerRegistry = event_listener_registry.EVENT_CATEGORIES = void 0;
		event_listener_registry.EVENT_CATEGORIES = ['keydown', 'keyup', 'keypress', 'mousemove', 'mousedown', 'mouseup'];
		...
		event_listener_registry.EventListenerRegistry = EventListenerRegistry;
		
		return event_listener_registry;
	}
	...
	var errors$2 = /*#__PURE__*/Object.freeze({
	    default: Errors
	});
	...
	var main_esm = /*#__PURE__*/Object.freeze({
		__proto__: null,
		'default': Flatten,
		Arc: Arc,
		BOUNDARY: BOUNDARY,
	...
	var require$$1 = /*@__PURE__*/getAugmentedNamespace(main_esm);
	...
	render.cloneRenderContextData = render.defaultRenderContextData = void 0;
	...
	render.defaultRenderContextData = defaultRenderContextData;
	...
	render.cloneRenderContextData = cloneRenderContextData;
	...
	function requireErrors () {
		...
		errors$1.EVENT_LISTENER_REGISTRY_NOT_ATTACHED = errors$1.INCORRECT_NON_CUSTOM_EVENT_TYPE = void 0;
		errors$1.INCORRECT_NON_CUSTOM_EVENT_TYPE = 'Incorrect event name for non-custom event.';
		errors$1.EVENT_LISTENER_REGISTRY_NOT_ATTACHED = 'Event listener registry not attached to entity. Attach it using "attachEventRegistry()" to register event listeners.';
	...
	const render_1 = render;
	const util$2 = tslib_1$2.__importStar(common);
	const errors = tslib_1$2.__importStar(requireErrors());
	class Entity {
	    ...
	    intersects(other) {
	        ...
	        util$2.assert(typeof thisShape.intersect === 'function', 'Shape has no \'intersect()\' method! Shape: ', thisShape);
	    ...
	    on(category, listener) {
	        util$2.assert(this.eventListenerRegistry != null, errors.EVENT_LISTENER_REGISTRY_NOT_ATTACHED);
	...
	Object.defineProperty(mouse_hit, "__esModule", { value: true });
	mouse_hit.mouseHit = mouse_hit.MouseHit = void 0;
	const tslib_1$1 = require$$0;
	const core_1 = tslib_1$1.__importDefault(require$$1);
	const quadtree_ts_1$1 = require$$1$1;
	const entity_1$1 = entity;
	const util$1 = tslib_1$1.__importStar(common);
	class MouseHit extends entity_1$1.Entity {
	    constructor(x, y) {
	        super();
	    ...
	    qtIndex(node) {
	        return quadtree_ts_1$1.Rectangle.prototype.qtIndex.call({
	            x: this.position_.x,
	            y: this.position_.y,
	            width: 0,
	            height: 0,
	    ...
	    set points(value) {
	        util$1.assert(value.length == 1, `A MouseHit is composed of a single point, you passed in ${value.length}!`);
	...
	mouse_hit.MouseHit = MouseHit;
	function mouseHit(event) {
	    return MouseHit.fromMouseEvent(event);
	}
	mouse_hit.mouseHit = mouseHit;

	var selectable_entity = {};

	Object.defineProperty(selectable_entity, "__esModule", { value: true });
	selectable_entity.SelectableEntity = void 0;
	...
	selectable_entity.SelectableEntity = SelectableEntity;

	Object.defineProperty(canvas, "__esModule", { value: true });
	canvas.Canvas = void 0;
	const tslib_1 = require$$0;
	const quadtree_ts_1 = require$$1$1;
	const util = tslib_1.__importStar(common);
	const event_listener_registry_1 = requireEvent_listener_registry();
	const mouse_hit_1 = mouse_hit;
	const selectable_entity_1 = selectable_entity;
	class Canvas {
	...
	var index = /*@__PURE__*/getDefaultExportFromCjs(candy2);
